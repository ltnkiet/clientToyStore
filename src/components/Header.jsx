            ...
            <div
              ...
              {isMenu && (
                <motion.div
                  ...
                  className="p-3 w-40 bg-white rounded-md shadow-md absolute top-12 right-0 flex items-center justify-center flex-col gap-4">
                  <Link
                    to={"/dashboard"}
                    className="text-base hover:text-violet-400 text-textColor">
                    Dashboard
                  </Link>
                  <Link
                    to={"/profile"}
